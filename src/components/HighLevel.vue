    ...
    <div >
        ...
        <div class="">
            <div class="flex flex-col justify-center items-center text-center">
                ...
                <div class="text-lg">Transtorno del espectro autista de nivel <b>ALTO</b></div><br>
                ...
                <div class="text-lg">- Comunicacion verbal y contacto visual.</div>
                <div class="text-lg">- Terapias del habla y lenguaje</div>
